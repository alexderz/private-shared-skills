...
- Independent instrumented lab tests (named lab, protocol, date)
- Multi-year owner reports with exact model + purchase/post date
- Technician / repair-community write-ups (failure mode + parts)
- Recall and complaint databases (agency, campaign id, date)
- Long specialist-forum posts that name model, config, and date

**Weak (discount or ignore as quality):**

- Affiliate listicles and “best of” roundups with referral links
- Marketplace star averages and “X,000 reviews”
- TikTok / Shorts / launch-week YouTube gush
...
Treat a review cluster as polluted when several of these show up:

- Burst of 5-stars in the launch week, then silence
- Generic praise, no model year, no config, no tenure
- Repeated phrases across “different” reviewers
- Reviewer history that is all 5-star, all one category, or brand-new
- Photos that do not match the SKU
- Vine / “received free” / incentivized badges
...
| Class | Cite as |
| --- | --- |
| Lab test | `[lab]` org, test name, date |
| Long-ownership | `[owner]` forum/site, model + config, tenure, post year |
| Technician / repair | `[tech]` community, repair type, date |
| Recall / complaint | `[recall]` agency, campaign/id, date |
| Specialist forum | `[forum]` board, model, date |
