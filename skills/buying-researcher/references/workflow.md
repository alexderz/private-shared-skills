# Buying workflow (court)

Court: run under progressive-research + Linear. These phases are not a second process — map them onto Pass 0 / Pass 1 / Pass 2+. One Linear Project per research track; Epics = passes/facets; Tasks = questions, sources, deliverable sections. Do not mint a second Project for the same track.

| Phase | Name | Progressive pass |
| --- | --- | --- |
...
| Grade | Meaning |
| --- | --- |
| Strong | Beats the criterion with evidence |
| Adequate | Meets it; no material risk |
...
| **Last-gen** | Outgoing SKU wins on price/parts and still does the job |
| **Skip** | Category, timing, or evidence does not support a buy |

State who the pick is **not** for, and what would change it.
