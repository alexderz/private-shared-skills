...
Aligns with SDLC Stage 5: review before integrate; reviewer is **fresh-context**, not the implementer session.
...
| Never | Why |
| --- | --- |
| Self-review as the only Stage 5 gate | SDLC fresh-context rule |
...
| --- | --- | --- |
| **architect** | Requesting fresh-context review | Treating self-LGTM as Stage 5 |
| **builder** | Fixing Critical/Important after the review | Using implementer-session memory as the review |
